...
@Component
@Slf4j
public class KakaoWebClientProxyImpl extends WebClientProxy {

    private WebClient webClient;

    // https://developers.kakao.com/docs/latest/ko/kakaologin/rest-api#sign-up
    private static final String KAKAO_LINK_URL = "https://kapi.kakao.com/v1/user/signup";
